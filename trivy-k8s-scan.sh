...
docker run --rm -v $WORKSPACE:/root/.cache/ -v "$PWD/.trivyignore":/.trivyignore:ro aquasec/trivy:0.17.2 -q image --exit-code 1 --severity CRITICAL --ingorefile /.trivyignore  --light $imageName
